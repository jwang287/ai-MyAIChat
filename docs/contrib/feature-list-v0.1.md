...
高级采集、更新与遥测、用量与发布说明等已确认扩展能力的桌面 AI 工作台。产品采用
...
| 非核心功能与扩展 | 14 | 4 项保留、10 项移除 | 已确认保留的扩展能力与不纳入精简版的能力。 |
...
1. **入口收敛**：移除侧边栏、启动台、路由、命令、设置和引导中的已确认移除功能；继续
   暴露已确认保留的代码助手、更新与遥测、用量与发布说明和高级采集入口。
2. **独立功能清理**：删除迷你应用、图片生成、联网搜索、外部渠道、云同步与第三方导入、
   局域网传输、笔记和文件工作区的实现。
3. **市场与服务端能力清理**：删除 MCP 市场、远程 MCP 安装和 API 网关；保留手动配置的
   本地 MCP 运行时及其工具审批。
