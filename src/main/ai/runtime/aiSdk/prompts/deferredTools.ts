...
<usage>
1. \`tool_search({ query?, namespace?, verbose? })\` — discover tools, grouped by namespace (e.g. \`kb\`, \`mcp:<server>\`). This is tool discovery, not an internet lookup. Pass \`verbose: true\` to include full input schemas.
