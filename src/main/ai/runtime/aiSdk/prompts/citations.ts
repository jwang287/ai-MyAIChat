 ...
 * citable knowledge-base tool (kb_search / kb_read) is exposed
...
When a statement in your answer is based on a kb_search or kb_read result, append a citation marker immediately after that statement: [cite:ID], where ID is the exact \`id\` field of the supporting result item.
